        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="text-lg max-w-prose mx-auto">
            ...
            <p className="mt-8 text-xl text-gray-500 leading-8">
              Information we request during the registration and checkout phases of an order: email, phone number, and address. These will not be shared with anyone for any reason. The checkout process is off loaded to paypal - which has its own build-in protections.
            </p>
          </div>
